...
import { Home, ArrowLeft, Sparkles, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-md w-full text-center">
        {/* Liquid glass orb */}
        <div
          className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-5 sm:mb-6 animate-float liquid-glass"
          style={{
        ...
        <p className="text-sm text-text_muted mb-6 sm:mb-8 max-w-xs mx-auto leading-relaxed">
          The page you're looking for doesn't exist or has been moved. Try navigating back or starting a new chat.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center px-4 sm:px-0">
          ...
          <Link to="/app/chat" className="w-full sm:w-auto">
            <button className="btn-liquid w-full sm:w-auto" style={{ minHeight: '42px', padding: '0 24px' }}>
              <MessageSquare className="w-4 h-4 z-content relative" />
              <span className="z-content relative">Open Chat</span>
            </button>
          </Link>
          <button
